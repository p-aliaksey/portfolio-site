...
- **Группировка алертов**: Критические, предупреждения, информационные
- **Автоматическая настройка**: Ansible playbooks для быстрой настройки
- **📖 Подробная инструкция**: [UBUNTU_ALERTING_SETUP.md](UBUNTU_ALERTING_SETUP.md)
